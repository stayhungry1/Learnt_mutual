...
net_belle = Cheng2020Anchor(N=192).cuda()

gpu_ids = [0,1,2]
model_finenet = define_G(256, 256, 128, 'global', 0, 9, 1, 3, 'instance', gpu_ids=gpu_ids).cuda() #3->0 64->128

print('%%%%%%P2inP3out%%%%%%%')
input_length_cheng = torch.randn(1, 256, 208, 208).cuda()
macs, params = profile(net_belle, inputs=(input_length_cheng,))
macs, params = clever_format([macs, params], "%.4f")
print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
print('{:<30}  {:<8}'.format('Number of parameters: ', params))
time_start = time.time()
_ = net_belle(input_length_cheng)  # [1,3,512,512]和[1,5,512,512]
time_end = time.time()
time_temp = time_end - time_start
print('Time: {:.4f}'.format(time_temp))

print('%%%%%%finenet%%%%%%%')
input_length_finenet = torch.randn(1, 256, 208, 208).cuda()
# macs, params = profile(model_finenet, inputs=(input_length_finenet,))
# macs, params = clever_format([macs, params], "%.4f")
# print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
# print('{:<30}  {:<8}'.format('Number of parameters: ', params))
input_finenet = torch.ones(1, 256, 208, 208).cuda()
time_start = time.time()
_ = model_finenet(input_finenet)  # [1,3,512,512]和[1,5,512,512]
time_end = time.time()
time_temp = time_end - time_start
print('Time: {:.4f}'.format(time_temp))

# print('%%%%%%P4inP4out%%%%%%%')
# input_length_cheng = torch.randn(1, 256, 64, 64).cuda()
# macs, params = profile(net_belle, inputs=(input_length_cheng,))
# macs, params = clever_format([macs, params], "%.4f")
# print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
# print('{:<30}  {:<8}'.format('Number of parameters: ', params))
...
#
# print('%%%%%%P5inP5out%%%%%%%')
# input_length_cheng = torch.randn(1, 256, 32, 32).cuda()
# macs, params = profile(net_belle, inputs=(input_length_cheng,))
# macs, params = clever_format([macs, params], "%.4f")
# print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
# print('{:<30}  {:<8}'.format('Number of parameters: ', params))
...
#
# print('%%%%%%P3inP3out%%%%%%%')
# input_length_cheng = torch.randn(1, 256, 112, 112).cuda()
# macs, params = profile(net_belle, inputs=(input_length_cheng,))
# macs, params = clever_format([macs, params], "%.4f")
# print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
# print('{:<30}  {:<8}'.format('Number of parameters: ', params))
