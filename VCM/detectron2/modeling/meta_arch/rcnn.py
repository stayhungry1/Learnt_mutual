...
import sys
sys.path.append("xxx/VCMbelle_06221/")
sys.path.append("xxx/VCMbelle_06221/VCM/")
...
class GeneralizedRCNN(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.i_step_count = 0
        compressai_logdir = '../../save/tensorboard_belle/P2inP3outMSE_P2zeroyouxiajiao256_lambda1/'
