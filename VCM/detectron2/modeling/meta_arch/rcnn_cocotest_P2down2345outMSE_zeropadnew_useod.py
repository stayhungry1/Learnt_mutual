...
class GeneralizedRCNN(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.path_bppsave = '/media/data/liutie/VCM/rcnn/liutie_save/output/chenganchor_P2down2P345_bpp_lambda1_cocotest5000_maskrcnn.json'
        self.path_bppsave_p2 = '/media/data/liutie/VCM/rcnn/liutie_save/output/chenganchor_P2down2P345_bpp_lambda1_cocotest5000_maskrcnn_P2.json'
        self.path_bppsave_p3 = '/media/data/liutie/VCM/rcnn/liutie_save/output/chenganchor_P2down2P345_bpp_lambda1_cocotest5000_maskrcnn_P3.json'
        self.path_bppsave_p4 = '/media/data/liutie/VCM/rcnn/liutie_save/output/chenganchor_P2down2P345_bpp_lambda1_cocotest5000_maskrcnn_P4.json'
        self.path_bppsave_p5 = '/media/data/liutie/VCM/rcnn/liutie_save/output/chenganchor_P2down2P345_bpp_lambda1_cocotest5000_maskrcnn_P5.json'
        self.bpp_test5000 = {}
        ...
        path_od = '/media/data/liutie/VCM/rcnn/liutie_save/lambda1_models/model_0135999.pth'
        self.net_belle_od = Cheng2020Anchor(N=192)
        self.net_belle_od = self.net_belle_od.to(device)
        pretrained_dict = torch.load(path_od)
        model_dict = self.net_belle_od.state_dict()
        pretrained_dict = {key[10:]: value for key, value in pretrained_dict['model'].items() if ('net_belle' in key)}  # 去掉前缀net_belle.
        model_dict.update(pretrained_dict)
        self.net_belle_od.load_state_dict(model_dict)
        print('load BFCNet trained by od: %s' %(path_od))
    ...
    def inference(
        ...
        # net_belle_output_p3 = self.net_belle(d_p3_new)
        ...
        psnr_temp = train_in_this_copyuseful.mse2psnr(out_criterion_p2["mse_loss"])
        mse_temp_up2 = define_mse(d_output_p2_up2, d_p2)
        psnr_temp_up2 = train_in_this_copyuseful.mse2psnr(mse_temp_up2)
        ...
        features["p2"] = d_output_p2_up2 * guiyihua_scale + guiyihua_min
