...
path_savepth = '/media/data/liutie/VCM/rcnn/VCMbelle_0622/VCM/EXP_cheng2020anchor_256chinput_P4MSE_lambda1_N192_smalltrain5W_eachdnorm_08172010/model_0009999.pth'
path_savenewpth = '/media/data/liutie/VCM/rcnn/VCMbelle_0622/VCM/EXP_cheng2020anchor_256chinput_P4MSE_lambda1_N192_smalltrain5W_eachdnorm_08172010/model_0009999_norcnn.pth'
net_belle = Cheng2020Anchor(N=192)
net_belle = net_belle.to(device)

# checkpoint = torch.load(path_savepth)
# # net_belle.load_state_dict(checkpoint['model'])
# net_belle.load_state_dict(checkpoint['model'], strict=False)
# # checkpoint = torch.load(path_savepth)
