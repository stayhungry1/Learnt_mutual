...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--index", default=32, type=int) #1
    ...
    if settings["model_name"] == "x101":
        ...
        methods_eval.prepare_part(picklist, data_name="pick") #QP10 QP11 QP13 QP20 QP21 QP12 QP22 QP31 QP32
        # methods_eval.prepare_part(picklist, data_name="pick1") #QP15 QP16 QP17 QP18 QP19
