...
class Eval:
    ...
    def _evaluation(self, fname):
        ...
        # fname_ds_rec = fname.replace('36_ori', '42_ds') #用QP42的未压缩的P2
        fname_p4_raw = fname.replace('36_ori', '42_ori') #用QP42的未压缩的P4
        ...
        features = self.feat2feat_p345(fname_p4_raw) #用QP42的未压缩的P3P4P5P6
