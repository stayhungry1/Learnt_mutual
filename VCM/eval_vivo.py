...
class Eval:
    def __init__(self, settings, index) -> None:
        ...
        self.path_bppsave = '../../liutie_save/output/chenganchor_P2down2P345_bpp_lambda8.json'
        self.path_bppsave_p2 = '../../liutie_save/output/chenganchor_P2down2P345_bpp_lambda8_P2.json'
        self.path_bppsave_p3 = '../../liutie_save/output/chenganchor_P2down2P345_bpp_lambda8_P3.json'
        self.path_bppsave_p4 = '../../liutie_save/output/chenganchor_P2down2P345_bpp_lambda8_P4.json'
        self.path_bppsave_p5 = '../../liutie_save/output/chenganchor_P2down2P345_bpp_lambda8_P5.json'
        self.bpp_test5000 = {}
    ...
    def feature_coding(self):   
        ...
        with tqdm(total=len(self.data_loader.dataset)) as pbar:
            for inputs in iter(self.data_loader):
                ...
                if (fname_temp != 'eeb18eb189719350') and (fname_temp != '00a159a661a2f5aa') and (fname_temp != '809a9c3af507dbfc') and (fname_temp != '7105f5486ecb5e61') and (fname_temp != '6306fc7f3573eb70') and (fname_temp != '363fbcd9d3492c8f'):
                    continue
    ...
    def _feature_coding(self, inputs, fname_temp):
        ...
        bpp_p45_temp = out_criterion_p4["bpp_loss"].item() + out_criterion_p5["bpp_loss"].item()
        print('[P2345] bpp: %8.4f' %(bpp_p45_temp))
        self.bpp_test5000[fname_temp] = [bpp_p45_temp]
